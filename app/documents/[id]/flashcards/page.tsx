          ...
          <div className="space-y-6">
            ...
            >
              ...
              >
                ...
                >
                  <div className="bg-primary/10 border-primary/50 border-2 w-full h-full rounded-lg flex items-center justify-center">
                    <p className="text-xl font-semibold text-center text-foreground">{currentCard.front}</p>
                  </div>
                </div>
                <div
                  className="absolute inset-0 w-full h-full border-2 rounded-lg p-8 flex items-center justify-center"
                ...
                >
                  <div className="bg-secondary/10 border-secondary/50 border-2 w-full h-full rounded-lg flex items-center justify-center">
                    <p className="text-xl text-center text-foreground">{currentCard.back}</p>
                  </div>
                </div>
              </div>
            </div>
